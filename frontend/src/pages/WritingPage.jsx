    ...
    <div className="min-h-screen bg-transparent relative z-10 w-full animate-fade-in-up">
      ...
      <section className="pt-24 pb-16 md:pt-32 md:pb-24 border-b border-border/50">
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center animate-fade-in-up">
          <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-violet-500/20 to-purple-500/20 shadow-inner flex items-center justify-center mx-auto mb-8">
            <PenTool className="h-10 w-10 text-violet-500 drop-shadow-sm" />
          </div>
          <h1 className="text-5xl md:text-6xl font-black tracking-tight text-foreground mb-6">
            IELTS <span className="text-transparent bg-clip-text bg-gradient-to-br from-violet-400 to-purple-600">Writing</span>
          </h1>
          <p className="text-muted-foreground text-xl mb-4 font-medium">
            {writingExercises.length} tasks available
          </p>
          <p className="text-muted-foreground/80 max-w-2xl mx-auto leading-relaxed text-lg">
            Master Academic and General Training writing tasks. Get instant AI-powered feedback on grammar, vocabulary, coherence, and task achievement.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-5xl mx-auto px-4 py-16 space-y-16">
        ...
        <div>
          ...
          <div className="space-y-4">
            {isLoading.writing ? (
              <div className="text-center py-12 text-violet-500 font-medium animate-pulse">Loading writing tasks...</div>
