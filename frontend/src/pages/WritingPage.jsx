...
const tips = [
  { icon, text: 'Plan your essay for 5 minutes before writing.' },
  { icon, text: 'Allocate 20 min for Task 1 and 40 min for Task 2.' },
  { icon, text: 'Use linking words to improve coherence and cohesion.' },
]
      ...
      <div className="max-w-5xl mx-auto px-4 py-14 sm:py-20 space-y-14">
        ...
        <div>
          ...
          <div className="space-y-3">
            {isLoading.writing ? (
              <div className="text-center py-8 text-violet-400 animate-pulse">Loading exercises...</div>
