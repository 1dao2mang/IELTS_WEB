...
const tips = [
  { icon, text: 'Record yourself and listen back for improvements.' },
  { icon, text: 'Part 2: Use 1 minute to plan, speak for 2 minutes.' },
  { icon, text: 'Extend answers naturally — don\'t give one-word replies.' },
]
