    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-slate-50 dark:bg-slate-900 border-b border-border py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-4">Speaking</h1>
          <p className="text-muted-foreground text-lg mb-4">
            {speakingExercises.length} exercises available
          </p>
      ...
      <div className="max-w-5xl mx-auto px-4 py-16 space-y-16">
        ...
        <div>
          ...
          <div className="space-y-4">
            {isLoading.speaking ? (
              <div className="text-center py-12 text-muted-foreground font-medium animate-pulse">Loading speaking tests...</div>
