...
Guest, I'd like to book a double room for three nights starting the 15th of March.
...
Books can be borrowed for 14 days, with one renewal allowed. Overdue fines are 50p per day. If you need help finding anything, just ask at the Help Desk near the main entrance.`,
  ...
  },
  {
    ...
    duration: 10,
    passage: `Tutor, James and Priya, how's the marine biology project going?
...
Those who advocate for free university education argue that it promotes social mobility and equal opportunity. When tuition fees represent a barrier, talented students from disadvantaged backgrounds may be discouraged from pursuing higher education, perpetuating cycles of inequality. Countries such and Norway, which offer free university education, consistently rank highly in social mobility indices. Furthermore, an educated population generates broader economic benefits through higher tax revenues, innovation, and reduced welfare dependency.
