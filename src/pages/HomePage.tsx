...
import {
  ...
  Star, Target, ArrowRight, Zap, Award, TrendingUp, Users, Clock
} from 'lucide-react'
...
const skills = [
  ...
  {
    icon: MessageCircle, label: 'Speaking', path: '/speaking',
...
const stats = [
  ...
  { icon: Target, value: '500+', label: 'Practice exercises' },
  { icon: Award, value: '7.5+', label: 'Avg band score' },
