...
export class ReadingSectionController {
  // GET /api/reading/sections/:sectionId
  getSectionById = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  startAttempt = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  getResult = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const { attemptId } = req.params;
