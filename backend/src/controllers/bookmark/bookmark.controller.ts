...
export class BookmarkController {
  // GET /api/bookmarks
  getAllBookmarks = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  // POST /api/bookmarks
  addBookmark = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const userId = BigInt((req as any).user?.id || 1);
  ...
  removeBookmark = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  updateBookmark = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const { bookmarkId } = req.params;
    const { note } = req.body;
