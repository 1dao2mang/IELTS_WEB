...
export class TestController {
  // GET /api/tests
  getAllTests = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  getTestSections = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const { testId } = req.params;
  ...
  getSectionQuestions = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  startTest = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const { testId } = req.params;
  ...
  getAttemptResult = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  submitAnswer = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const { attemptId } = req.params;
